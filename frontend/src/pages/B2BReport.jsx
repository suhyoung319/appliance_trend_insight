...
const ACTION_CONFIG = {
  ...
  '관망':      { color: '#8e8e93', bg: 'rgba(142,142,147,0.06)', border: 'rgba(142,142,147,0.2)', icon: '◎' },
};
              ...
              <>
                ...
                <div className={s.section}>
                  ...
                  <div className={s.conclusionCard}>
                    ...
                    {report.summary && (
                      <p className={s.conclusionNote}>{report.summary}</p>
                    )}
                    {brands.length > 0 && (
                          ...
                          <ol className={s.strategyList}>
                            {items.map((item, i) => (
                              <li key={i} className={s.strategyItem}>
                                <span className={s.strategyNum} style={{ background: `${color}18`, color }}>{i + 1}</span>
                                {item}
                              </li>
                            ))}
                          </ol>
