...
function KeywordSection({ title, items, isComplaint }) {
          ...
          <>
            ...
            {keywords.length > 0 && (
              <div className={s.section}>
                ...
                <KeywordSection title="주요 관심 키워드" items={keywords} isComplaint={false} />
              </div>
            )}
                      ...
                      {report.summary.conclusion && (
                        <div className={s.aiReportRow}>
                          ...
                          <div>
                            ...
                            <p className={s.aiConclusion}>{report.summary.conclusion}</p>
                          </div>
                        </div>
                      )}
                    </div>
