...
async def get_ai_report(category: str = Query(..., min_length=1), period: str = "3m", _: dict = Depends(require_b2b)):
    ...
    try:
        ...
        prompt = (
            ...
            f'  ],\n'
            f'  "action_list": [\n'
            f'    {{"stars": 5, "action": "가장 시급한 실행 항목 (20자 이내)", "dept": "담당 부서 (상품기획·마케팅·구매·영업 중 택1)", "timing": "이번 주"}},\n'
            f'    {{"stars": 5, "action": "두 번째 우선순위 항목 (20자 이내)", "dept": "담당 부서", "timing": "7일 이내"}},\n'
            f'    {{"stars": 4, "action": "세 번째 우선순위 항목 (20자 이내)", "dept": "담당 부서", "timing": "2주 이내"}},\n'
            f'    {{"stars": 3, "action": "네 번째 우선순위 항목 (20자 이내)", "dept": "담당 부서", "timing": "이번 달"}},\n'
            f'    {{"stars": 2, "action": "다섯 번째 우선순위 항목 (20자 이내)", "dept": "담당 부서", "timing": "다음 달"}}\n'
            f'  ]\n'
            f'}}\n\n'
            f'[절대 규칙]\n'
            ...
            f'8. action_list: 실제 카테고리({category})에 맞는 구체적 실행 항목 5개. action은 20자 이내 실행 가능한 문장. dept는 상품기획·마케팅·구매·영업 중 택1. timing은 "이번 주", "7일 이내", "2주 이내", "이번 달", "다음 달" 중 택1.\n'
