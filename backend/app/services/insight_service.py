...
1. 참고 문서가 질문한 제품·카테고리와 관련이 없으면, 리포트 형식 없이 단 한 문장으로만 응답하세요: "해당 제품 관련 데이터가 부족합니다. 다른 제품명이나 카테고리를 입력해주세요."
2. 아래 참고 문서에 실제로 언급된 내용만 작성하세요.
3. 문서에 없는 내용은 추측하거나 단정하지 마세요. 근거 없는 항목은 생략하거나 "확인된 정보 없음"으로 표기하세요.
4. 각 주장 뒤에 출처 번호를 [1], [2] 형식으로 반드시 표기하세요.
5. 일반 소비자가 이해하기 쉬운 구어체로 작성하세요.
6. 반드시 아래 마크다운 형식으로만 응답하세요. JSON 금지.
...
3. 문서에 없는 내용은 추측하거나 단정하지 마세요. 근거 없는 항목은 생략하거나 "확인된 정보 없음"으로 표기하세요.
4. 각 주장 뒤에 출처 번호를 [1], [2] 형식으로 반드시 표기하세요.
5. 비즈니스 관점의 인사이트와 전략적 시사점을 중심으로 작성하세요.
6. 반드시 아래 마크다운 형식으로만 응답하세요. JSON 금지.
